...
class RepoVersionTests(unittest.TestCase):
    """Test that the `rules_vivado` versions match for WORKSPACE and bzlmod."""
    ...
    def test_versions(self) -> None:
        ...
        version_bzl = rlocation(runfiles, "rules_vivado/version.bzl")
        ...
        module_bazel = rlocation(runfiles, "rules_vivado/MODULE.bazel")
