...
load(
    ...
    _vivado_write_bitstream = "vivado_write_bitstream",
    _vivado_write_device_image = "vivado_write_device_image",
)
...
vivado_write_device_image = _vivado_write_device_image
